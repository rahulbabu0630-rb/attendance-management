          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="space-y-6">
              ...
              <ul className="space-y-3">
                ...
                <li><a href={`${BASE_URL}/locations`} className="text-gray-700 hover:text-pink-600 transition-colors">Our Stores</a></li>
                <li><a href={`${BASE_URL}/shop`} className="text-gray-700 hover:text-pink-600 transition-colors">Online Shop</a></li>
                <li><a href={`${BASE_URL}/careers`} className="text-gray-700 hover:text-pink-600 transition-colors">Careers</a></li>
                <li><a href={`${BASE_URL}/gifts`} className="text-gray-700 hover:text-pink-600 transition-colors">Corporate Gifts</a></li>
              </ul>
            </div>
            ...
            <div className="space-y-6">
              ...
              <ul className="space-y-3">
                <li><a href={`${BASE_URL}/products/sweets`} className="text-gray-700 hover:text-pink-600 transition-colors">Traditional Sweets</a></li>
                <li><a href={`${BASE_URL}/products/cakes`} className="text-gray-700 hover:text-pink-600 transition-colors">Cakes & Pastries</a></li>
                <li><a href={`${BASE_URL}/products/dryfruits`} className="text-gray-700 hover:text-pink-600 transition-colors">Dry Fruit Sweets</a></li>
                <li><a href={`${BASE_URL}/products/snacks`} className="text-gray-700 hover:text-pink-600 transition-colors">Savory Snacks</a></li>
                <li><a href={`${BASE_URL}/products/gifts`} className="text-gray-700 hover:text-pink-600 transition-colors">Gift Boxes</a></li>
              </ul>
            </div>
